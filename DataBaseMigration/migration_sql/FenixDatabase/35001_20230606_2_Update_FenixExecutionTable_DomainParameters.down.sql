...
SET "ExecutionWorker Address" = 'fenixexecutionworker-ca-must-be-logged-in-nwxrrpoxea-lz.a.run.app'
WHERE "DomainUuid" = '78a97c41-a098-4122-88d2-01ed4b6c4844';

UPDATE "FenixExecution"."DomainParameters"
SET "ExecutionWorker Address" = 'fenixexecutionworker-sc-must-be-logged-in-nwxrrpoxea-lz.a.run.app'
