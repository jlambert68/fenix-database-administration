...
func migrateDatabase(targetDatabase string,
	...
	useTargetStepOrRelativeStepsToMigrateInDevEnvironment SharedCode.UseTargetStepOrReleativeStepsType,
	useTargetStepOrRelativeStepsToMigrateInAccEnvironment SharedCode.UseTargetStepOrReleativeStepsType,
) {
	...
	var useTargetStepOrRelativeStepsToMigrate SharedCode.UseTargetStepOrReleativeStepsType
	...
	if err != nil {
		...
		if SharedCode.ExecutionEnvironment == SharedCode.DEV {
			SharedCode.Logger.WithFields(logrus.Fields{
				...
				"err": err,
				"SharedCode.SecretManagerPathForPostgresDbPassword+version": SharedCode.SecretManagerPathForPostgresDbPassword + SharedCode.LatestSecretVersion,
	...
	*/
	...
	migrationObject.Log = &SharedCode.MigrateLogger{
		Logger: SharedCode.Logger,
	}
	...
	if useTargetStepOrRelativeStepsToMigrate == SharedCode.UseTargetStep &&
	...
	if useTargetStepOrRelativeStepsToMigrate == SharedCode.UseRelativeSteps && methodFound == false {
	...
	if useTargetStepOrRelativeStepsToMigrate == SharedCode.UseTargetStep && methodFound == false {
...
func listTablesInDatabase(db *sql.DB, schemaName string) (tablesInDatabase []string, err error) {
	...
	sqlToExecute = sqlToExecute + "WHERE schemaname IN ('" + SharedCode.DBNameFenixDatabasesSchemaFenixBuilder + "', "
	sqlToExecute = sqlToExecute + "'" + SharedCode.DBNameFenixDatabasesSchemaFenixDomainAdministration + "') ;"
